...
if ( ! function_exists( 'tyros_setup' ) ) :
	...
	function tyros_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'tyros' ),
		) );
...
function tyros_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'tyros_content_width', 640 );
}
...
function tyros_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'tyros' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'tyros' ),
...
function tyros_scripts() {
	...
	wp_enqueue_script( 'tyros-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'tyros-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
