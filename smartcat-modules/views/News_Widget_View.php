...
if ( $news->have_posts() ) : ?>
    ...
    <div class="tyros-news <?php echo isset( $instance['scmod_news_widget_width'] ) ? 'col-sm-' . $instance['scmod_news_widget_width'] : 'col-sm-12'; ?>">
...
<?php else : ?>
    ...
    <h4 class="none-to-display"><?php _e( 'There are currently no News items to display, please check again at a later time.', 'tyros' ); ?></h4>
