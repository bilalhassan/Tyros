...
if ( $events->have_posts() ) : ?>
    ...
    <div class="tyros-events <?php echo isset( $instance['scmod_events_widget_width'] ) ? 'col-sm-' . $instance['scmod_events_widget_width'] : 'col-sm-12'; ?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="event-post">
                                ...
                                <div class="event-details">
                                    ...
                                    <a class="tyros-button" href="<?php echo esc_url( get_the_permalink( get_the_ID() ) ); ?>"><?php _e( 'Learn More', 'tyros') ?></a>
...
<?php else : ?>
    ...
    <h4 class="none-to-display"><?php _e( 'There are currently no upcoming events, please check again at a later time.', 'tyros' ); ?></h4>
